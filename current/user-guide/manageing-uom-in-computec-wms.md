...
![Inventory Transfer Request](./media/document-in-sap.webp)

A Pick List for this document:

![Pick List](./media/pick-list-in-sap.webp)
...
![UoM Code](./media/uom-inventory.webp)

b. Check the highlighted checkbox:

![Stock Transfer](./media/cc-stock-transfer-uom.webp)

Now CompuTec WMS takes UoM from the Sales Data tab:

![Sales Data](./media/sales-uom.webp)
...
![New Item](./media/application-settings-document.webp)

![Document Details](./media/cc-query-manager-result-2.webp)
